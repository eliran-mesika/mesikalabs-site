...
- First viewport must show the MesikaLabs brand, the four app icons, primary app links, and a hint of the latest posts section.
...
- Use real product icons/screenshots when possible. Do not use abstract orb or blob decorations.
