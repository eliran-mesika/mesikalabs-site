...
| `smartpiece.mesikalabs.com` | `/Users/eliranmesika/Repos/smartpiece-site` | pending | GitHub Pages, `main` branch root | Local site created; live hosting not configured in this run | Dedicated SmartPiece public site. Godot app repo is source truth, not the website host. |
