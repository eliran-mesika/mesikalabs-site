...
| `brainmarshal.mesikalabs.com` | `/Users/eliranmesika/Repos/mathwar-site` | `eliran-mesika/mathwar-site` | GitHub Pages, `main` branch root | HTTPS 200, certificate approved, HTTPS enforced | Dedicated BrainMarshal public site; the legacy mathwar hostname redirects here. This is the source to update for BrainMarshal App Store support, privacy, terms, and marketing pages. |
